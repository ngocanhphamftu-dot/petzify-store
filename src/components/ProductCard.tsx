      ...
      <div className="p-4">
        ...
        {product.rating_count > 0 && (
          <div className="flex items-center gap-1 mb-2">
            <div className="flex">
              {[1,2,3,4,5].map((star) => (
                <svg key={star} className={`w-3 h-3 ${star <= Math.round(parseFloat(product.average_rating)) ? "text-yellow-400" : "text-gray-200"}`} fill="currentColor" viewBox="0 0 20 20">
        ...
        <button
          ...
          className="w-full bg-[#F36621] hover:bg-[#d4551a] text-white font-semibold text-sm py-2 rounded-xl transition-colors"
        >
          Add to Cart
        </button>
      </div>
